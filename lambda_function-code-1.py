...
def create_key(uname):
    try:
        ...
        ops_sns_topic = "arn:aws:sns:us-east-1:052805659558:test" #Topic arn would be inserted here
    ...
    for u in iam_users:
        ...
        if len(user_key_details)== 1:            
            ...
            if 'days' in str(len_days_diff):
                ...
                if 0 < abs(int(len_days_diff)) < 5: 
                    pass
                elif 5 <= abs(int(len_days_diff)) < 7: 
